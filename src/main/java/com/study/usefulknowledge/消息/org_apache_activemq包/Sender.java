package com.study.usefulknowledge.消息.org_apache_activemq包;
...
//        connectionFactory = new ActiveMQConnectionFactory(ActiveMQConnection.DEFAULT_USER, ActiveMQConnection.DEFAULT_PASSWORD, "tcp://localhost:61616");
        connectionFactory = new ActiveMQConnectionFactory("app", "app82193302", "tcp://124.254.45.82:61613");
        try { // 构造从工厂得到连接对象
            ...
            destination = session.createQueue("app.test");
            // 得到消息生成者【发送者】
